...
namespace modules\TVSinPagar\host;

class SynoFileHostingTVSinPagar
{
    private $url;
    ...
    public function GetDownloadInfo()
    {
        ...
        $result[DOWNLOAD_URL] = $this->getTorrentUrlTVSinPagar($curl);        

        return $result;
    }

    private function getTorrentUrlTVSinPagar($curl)
    {
        $result = '';
